...
procedure luaL_getmetatable(L: Plua_State; const tname: PChar); cdecl;
...
function luaL_findstring(st: PChar; const lst: PPChar): Integer; cdecl;
...
function lua_dofile(L: Plua_State; const filename: PChar): Integer; cdecl;
function lua_dostring(L: Plua_State; const str: PChar): Integer; cdecl;
function lua_dobuffer(L: Plua_State; const buff: PChar; size: Integer; const name: PChar): Integer; cdecl;
...
function lua_dofile(L: Plua_State; const filename: PChar): Integer; cdecl; external LUA_LIB_NAME;
function lua_dostring(L: Plua_State; const str: PChar): Integer; cdecl; external LUA_LIB_NAME;
function lua_dobuffer(L: Plua_State; const buff: PChar; size: Integer; const name: PChar): Integer; cdecl; external LUA_LIB_NAME;
